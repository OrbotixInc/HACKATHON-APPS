 ...
 * within a view.  The data may come from an {@link org.hermit.android.instruments.Instrument} or
 * some other source.
 *
 * <h2>Configuration</h2>
 *
 * <p>Your gauge will be notified of its geometry by a call to
 * {@link #setGeometry(android.graphics.Rect)}.  This is where you should note your position
 * and size and perform any internal layout you need to do.
 *
 * <p>Note that if you are running in an app which handles screen
 * configuration changes, {@link #setGeometry(android.graphics.Rect)} will be called any
 ...
 * simply call {@link #draw(android.graphics.Canvas, long, boolean)}, passing true
 * as the last argument.  This asks the Gauge to draw its background and
 * its content.
 *
 * <p>In the caching case, the caller should call
 * {@link #drawBackground(android.graphics.Canvas)} to ask the gauge to draw its
 ...
 * and then call {@link #draw(android.graphics.Canvas, long, boolean)}.
 *
 * <h2>Drawing Sequence -- Implementor</h2>
 *
 * <p>From the Gauge implementor's point of view, there are two routines
 * to implement: {@link #drawBackgroundBody(android.graphics.Canvas, android.graphics.Paint)} (optional), and
 * {@link #drawBody(android.graphics.Canvas, android.graphics.Paint, long)}.
 *
 * <p>If your implementation of {@link #drawBody(android.graphics.Canvas, android.graphics.Paint, long)}
 ...
 * Do this by implementing {@link #drawBackgroundBody(android.graphics.Canvas, android.graphics.Paint)}.
 ...
 * at the end of {@link #setGeometry(android.graphics.Rect)}.  At that point, your background
...
public class Gauge
{
	 ...
	 * set -- for example at the end of {@link #setGeometry(android.graphics.Rect)} --
     ...
     *                      {@link #drawBackground(android.graphics.Canvas)} before
     *                      this method.
     */
