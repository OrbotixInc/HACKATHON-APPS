 ...
 * an extension of {@link org.hermit.android.core.SurfaceRunner} which provides additional
	...
	extends SurfaceRunner
{
     ...
     * {@link org.hermit.android.instruments.Instrument#doUpdate(long)} method will be called each
     ...
     * {@link org.hermit.android.instruments.Instrument}, it should be attached to the surface with
     * {@link #addInstrument(org.hermit.android.instruments.Instrument)}.
     *
     * <p>All gauges added here will have their
     * {@link Gauge#draw(android.graphics.Canvas, long, boolean)} method called each
     * time round the main animation loop.
     * 
...
//            canvas.drawColor(0xff000000);
        ...
        canvas.drawText(new Long(instantEnergy).toString(), 30.0f, 30.0f, paint);
        canvas.drawText(new Long(fftLag).toString(), 30.0f, 90.0f, paint);
...
//            gaugeArray[g].draw(canvas, now, needBg);
    ...
    public void setScreenColor(int newColor) {
        screenColor = newColor;
    }

    public void setInstantEnergy(long energy) {
        instantEnergy = energy;
    }

    public void setFFTLag(long time) {
        fftLag = time;
    }
    ...
    private int screenColor = 0xff000000;
    private long instantEnergy = 0;
    private long fftLag = 0;
}
