...
public class JoystickWheel extends Drawable {
    ...
    private final Dim size = new Dim();
    private final Index position = new Index();
    ...
    /**
     * Gets the center position of the puck wheel, as an index.
     * @return an Index, containing the center point of the puck wheel
     */
    public Index getPosition(){
        return new Index(this.position);
    }
